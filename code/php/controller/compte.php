            ...
            <div class="row">
                ...
                <div class="col-lg-10 col-sm-12 ">
                    <div class="tab-content" id="nav-tabContent">
                                                ...
                                                <div class="collapse mt-2" id="collapseMdp">
                                                    <div class="card card-body">
                                                        <form id="updatePassword">
                                                            ...
                                                            <button type="submit" class="btn btn-outline-info mb-2 mt-2" id="updatePasswordBtn" name="updatePassword">Confirmer la modification</button>
                                                        </form>
                                                    </div>
                                                </div>
                        ...
                        <div class="tab-pane fade mb-5" id="panelAddAnimal" role="tabpanel" aria-labelledby="list-addAnimal-list">
